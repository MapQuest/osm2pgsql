...
std::pair<int, bool> output_pgsql_t::way_cb_func::finish(int max_count, int exists) {
...
std::pair<int, bool> output_pgsql_t::rel_cb_func::finish(int max_count, int exists) {
    struct keyval tags_int;
